  ...
  return (
    ...
    >
      <div className=" w-full md:w-[50%] ">
        <h1 className="font-bold text-[26px] lg:text-[60px] leading-tight mb-3 md:mb-[28px] 2xl:text-[95px] 2xl:mb-[50px]">
          Your Health, <br className="md:block hidden" />
          Just a Click Away
        </h1>
        <p className=" text-[12px] md:text-[15px] mb-3 2xl:text-[30px] md:mb-[60px]">
        ...
        <div className="flex items-center justify-center bg-white shadow-lg rounded-full  w-[75%] md:h-[40px] md:max-w-md 2xl:h-[70px]">
          <input
            ...
            className="flex-grow md:px-4 text-sm rounded-full  focus:outline-none placeholder-[#2e2e2e] placeholder:text-[11px] placeholder:pl-3 pl-3 2xl:placeholder:text-[26px]"
          />
      ...
      <div className="relative w-full mb-2 grid md:w-[50%] overflow-clip">
        <img
          src={vector}
          alt="splash"
          className=" md:max-h-[444px] xl:w-full xl:min-h-[440px] 2xl:min-h-[700px] col-start-1 row-start-1 xl:h-fit  "
        />
        <img
          src={hero}
          alt="hero"
          className="  md:h-[380px] xl:h-fit xl:min-h-[440px] 2xl:min-h-[700px]  col-start-1 row-start-1"
        />
      </div>
    </section>
  );
