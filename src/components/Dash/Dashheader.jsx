...
const Dashheader = () => {
  ...
  return (
    <header className="mx-[15px] md:mx-[50px] h-[55px] py-6 ">
        ...
        <div className="flex justify-between items-end">
          <nav className="hidden md:flex flex-1 justify-end items-center w-[70%]">
            ...
            <Link
              ...
              aria-label="Log in"
            >
              <div className="w-8 h-8 rounded-full flex justify-center items-center bg-blue-800">
                p
              </div>
            </Link>
            <Link to="/Cart">
              <button
                ...
                aria-label="Sign Up"
              >
                <img src="/cart.svg" alt="cart" className="w-[24px] h-[24px]" />
              </button>
            </Link>
          </nav>
