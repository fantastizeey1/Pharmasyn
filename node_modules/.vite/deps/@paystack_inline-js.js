...
function c(n2, e2) {
  ...
  var t2, a2, o2 = function(n3, e3) {
    ...
    for (a3 = 0; a3 < i3.length; a3++)
      t3 = i3[a3], e3.indexOf(t3) >= 0 || (o3[t3] = n3[t3]);
    return o3;
  }(n2, e2);
  if (Object.getOwnPropertySymbols) {
    var i2 = Object.getOwnPropertySymbols(n2);
    for (a2 = 0; a2 < i2.length; a2++)
      t2 = i2[a2], e2.indexOf(t2) >= 0 || Object.prototype.propertyIsEnumerable.call(n2, t2) && (o2[t2] = n2[t2]);
  }
  return o2;
}
function s(n2, e2) {
...
function u(n2, e2) {
  ...
  for (var t2 = 0, a2 = new Array(e2); t2 < e2; t2++)
    a2[t2] = n2[t2];
  return a2;
}
...
function O(n2, e2, a2) {
  ...
  return new Promise(function(e3, o3) {
    if (n2)
      if (T(i2)) {
        if (I(n2))
          return s2.applePay = true, void e3(s2);
        (function(n3, e4) {
          ...
          if (a2 && 1077497 !== a2 && window && !Array.isArray(window.webpackJsonp))
            throw new Error("Incorrect data type for 'webpackJsonp', expected array, got ".concat(t(window.webpackJsonp), ". Switching to fallback apple pay button"));
          !function(n3, e4) {
        ...
        o3("No wallet payment method is available on this device");
    else
      o3("Container to mount elements was not provided");
  });
}
function j(n2) {
  for (; n2.firstChild; )
...
var tn = { initializeLog: function(n2) {
  ...
  try {
    if (this.response)
      return nn(this.id, this.response.merchant_key, this.log);
  } catch (n2) {
  }
}, saveIpAddress: function() {
  try {
    if (this.response)
      return en(this.id, this.response.merchant_key);
  } catch (n2) {
  }
} };
...
var rn = function() {
  function n2(e2) {
    a(this, n2), function(n3) {
      ...
      if (!n3 || "object" !== t(n3))
        throw new e3("Transaction parameters should be a non-empty object");
      var a2 = n3;
      if ("accessCode" in a2)
        return { accessCode: a2.accessCode };
      ...
      if (Q.filter(function(n4) {
        ...
        throw new e3("Invalid transaction parameters", i3);
...
var kn = function() {
  function n2(e2) {
    ...
    a(this, n2), this.id = function() {
      for (var n3 = "", e3 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", t3 = 0; t3 < 5; t3 += 1)
        n3 += e3.charAt(Math.floor(Math.random() * e3.length));
      return n3;
  ...
  return i(n2, [{ key: "registerListeners", value: function() {
    ...
    return ln = this, new Promise(function(i2, r2) {
      ...
      if (A()) {
        ...
        if (n3 && n3.loadPaystackCheckoutButton)
          if (c2) {
            var p2 = ln.preloadTransaction(o2);
            c2.onclick = p2;
          } else
            cn("This device does not support any payment request wallet options. Please consult our documentation at https://developers.paystack.co/docs/paystack-inline to see how to load alternative payment options using 'loadPaystackCheckoutButton'");
        a2 && a2(null);
    ...
    if (s2) {
      ...
      vn("Could not initiate apple pay transaction");
          ...
          switch (i2) {
            case "loaded:checkout":
              if (this.isLoaded = true, a2)
                hn({ checkoutIframe: this.checkoutIframe, urlParameters: a2.urlParameters });
              break;
    ...
    if (o2 && ("string" == typeof o2 || o2 instanceof String)) {
      ...
      if (i2 && "PaystackClose" === i2.action)
        i2.data && a2.onSuccess(o2);
...
if (gn = g().length > 0, bn = f() && "FORM" === f().parentElement.tagName, gn && bn) {
  xn = function() {
    ...
    return g().forEach(function(e2) {
      ...
      if (n3.buttonId && !document.getElementById(n3.buttonId))
  ...
  ln || (ln = new kn()), function(n2) {
    var e2;
    if (n2.id)
      (e2 = document.getElementById(n2.id)).setAttribute("data-inline-id", n2.id);
    else {
